...
namespace OculusSampleFramework
{
    public class DistanceGrabbable : OVRGrabbable
    {
        ...
        protected override void Start()
        {
            ...
            if (m_renderer) m_renderer = gameObject.GetComponent<Renderer>();
            m_crosshairManager = FindObjectOfType<GrabManager>();
            m_mpb = new MaterialPropertyBlock();
            RefreshCrosshair();
            m_mpb.SetColor(m_materialColorField, Color.white);
            if (m_renderer) m_renderer.SetPropertyBlock(m_mpb);
        }
        ...
        void RefreshCrosshair()
        {
            ...
            {
                if (m_renderer) m_renderer.GetPropertyBlock(m_mpb);
